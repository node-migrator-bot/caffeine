// Generated by CoffeeScript 0.1.0
(function() {
  ...
  exports.If = If = (function(_super) {
    ...
    exports.Package = Package = (function(_super2) {

      __extends(Package, _super2);

      Package.name = 'Package';

      function Package(namespace, classes) {
        this.namespace = namespace;
        this.classes = classes;
      }

      Package.prototype.children = ['namespace', 'classes'];

      Package.prototype.compileNode = function(o) {
        var className, item, properties, _i, _len, _ref3;
        properties = [];
        _ref3 = this.classes;
        for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
          item = _ref3[_i];
          ...
          if (className === null) {
            throw new Error("cannot create an anonymous class in the package " + (this.namespace.compile(o)));
          }
          properties.push(new Assign(new Value(new Literal(className)), item, 'object'));
        }
        if (properties.length === 0) {
          return "" + (utility('namespace')) + "(" + (this.namespace.compile(o)) + ", {})";
        }
        return "" + (utility('namespace')) + "(" + (this.namespace.compile(o)) + ", " + (new Obj(properties, true).compile(o)) + ")";
      };
  ...
  UTILITIES = {
    ...
    namespace: function() {
      return 'function(ns, hashSet){ if (!(hashSet instanceof Object) || hashSet instanceof Array || typeof hashSet === "function") {return null;} var obj = this,nsa = ns.split(".");for (var i = 0, l = nsa.length; i < l; i++) { var pack = nsa[i];obj = obj[pack] || (obj[pack] = {}); } for (var key in hashSet) { obj[key] = hashSet[key]; } return obj; }';
    }
  };
