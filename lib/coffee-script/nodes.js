...
(function() {
  ...
  exports.If = If = (function(_super) {
    ...
    exports.Package = Package = (function(_super2) {
      ...
      Package.prototype.compileNode = function(o) {
        var className, item, namespace, properties, root, _i, _len, _ref3;
        properties = [];
        _ref3 = this.classes;
        for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
          item = _ref3[_i];
        ...
        root = this.namespace.shift().compile(o);
        Scope.root.assign(root, "{}");
        namespace = "[" + (this.namespace.join(",").trim()) + "]";
        if (properties.length === 0) {
          return "" + (utility('namespace')) + "(" + root + ", " + namespace + ", {})";
        }
        return "" + (utility('namespace')) + "(" + root + ", " + namespace + ", " + (new Obj(properties, true).compile(o)) + ")";
      };
  ...
  UTILITIES = {
    ...
    namespace: function() {
      return 'function(root, array, hash) { for (var i = 0, l = array.length; i < l; i++) { var pack = array[i];root = root[pack] || (root[pack] = {}); } for (var key in hash) root[key] = hash[key]; return root; }';
    }
  };
