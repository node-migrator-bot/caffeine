...
(function() {
      ...
      return deepWatch(source, watchList, function() {
        ...
        for (_i = 0, _len = watchList.length; _i < _len; _i++) {
          ...
          _results.push((function(filename) {
            return watchers[filename] = fs.watch(filename, function() {
        ...
        return fs.stat(filename, function(err, stats) {
          ...
          return process.nextTick(function() {
            return fs.readFile(filename, function(err, code) {
              var expr, filepath, importExists, nodes, _i, _len, _ref2;
              ...
              _ref2 = (nodes != null ? nodes.expressions : void 0) || [];
              for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
                expr = _ref2[_i];
  ...
  version = function() {
    return printLine("Caffeine version " + CoffeeScript.VERSION);
  };
