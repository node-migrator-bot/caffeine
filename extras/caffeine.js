...
(function() {
  ...
  exports.Import = Import = (function(_super) {
    ...
    Import.prototype.filename = function(o) {
      var dir, file, location, ns, search;
      if (o == null) o = {};
      location = "" + (((function() {
        var _i, _len, _ref3, _results;
      ...
      file = o.filename === "repl" ? ".coffee" : o.filename;
    ...
    Import.prototype.checkImports = function(o, variable, file) {
      var call, code, lexer, literalKey, relative;
    ...
    Import.assignImports = function(o) {
      var call, ctor, func, properties, property, thisLit, value, _i, _len, _ref3;
      o = extend({}, o);
      o.indent += TAB;
      properties = {
        list: new Literal("{}"),
      ...
      ctor.body.push(new Literal("(function(a, b, c) { " + "while (c = a.shift()) { " + "c[1](b[c[0]]); " + "} " + "})(this.delayed, this.list)"));
